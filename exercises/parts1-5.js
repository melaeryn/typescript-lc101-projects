...
var Spacecraft = /** @class */ (function () {
    function Spacecraft(givenName, speedMPH) {
...
//console.log(`${spaceShuttle.spacecraftName} would take ${spaceShuttle.getDaysToLocation(kilometersToMars)} days to get to Mars.
//${spaceShuttle.spacecraftName} would take ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days to get to the Moon.`);
